                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-white">Login hanya untuk staff!</h1>
                            <p class="text-lead text-white">Hanya staff <span class="nama-web" style="font-size: 24px; color:white;">&nbsp; filmin &nbsp;</span> yang dapat mengakses</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card bg-secondary shadow border-0">
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            <div class="text-center text-muted mb-4">
                                <small>Masuk sebagai staff</small>
                            </div>
                            ...
                            <form method="post" action="<?php echo base_url('auth/login'); ?>">
                                ...
                                <div class="text-center">
                                    <input type="submit" name="submit" class="btn btn-primary my-4" value="Masuk">
                                </div>
                            </form>
                        </div>
                    </div>
