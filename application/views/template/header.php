    ...
    <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-center">
                <a class="nama-web mr-lg-5" href="<?php base_url() ?>" style="font-size:40px;">
                    ...
                    <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media align-items-center">
                            <span class="avatar avatar-sm rounded-circle">
                                <img alt="Image placeholder" src="<?php echo base_url('assets/img/noavatar.png'); ?>">
                            </span>
                        </div>
                    </a>
                    ...
                    <?php if ($this->session->userdata('level') === 'administrator') : ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo base_url('film'); ?>">
                                <i class="fas fa-film text-red"></i> Film
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo base_url('pemesanan'); ?>">
                                <i class="fas fa-file-invoice text-green"></i> Pemesanan
                            </a>
                        </li>
                    <?php endif; ?>
                        ...
                        <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body ml-2 d-none d-lg-block">
                                    <span class="mb-0 text-sm font-weight-bold"><?php echo ucwords(strtolower($this->session->userdata('username'))); ?></span>
                                </div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
